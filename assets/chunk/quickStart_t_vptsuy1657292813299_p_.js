import"./pinia.js";import{M as s}from"./vue.js";const l=s({components:{},template:`<div class="fv-mardown-html"><div class="fv-mardown-main tp-doc"><fv-toc><nav class="table-of-contents"></nav></fv-toc><h2 id="\u4E0B\u8F7D\u5B89\u88C5" tabindex="-1"><a class="header-anchor" href="#\u4E0B\u8F7D\u5B89\u88C5">#</a> \u4E0B\u8F7D\u5B89\u88C5</h2>
...
</div></div><PagesRouter  docPath="en/guide/quickStart.md" mapType="docs" docRepo="tinymce-plugin-docs" pagesName="quickStart_t_vptsuy1657292813299_p_" />`});export{l as default};
