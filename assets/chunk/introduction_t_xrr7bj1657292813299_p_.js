...
<hr>
<blockquote>
<p>Welcome <a href="https://github.com/tinymce-plugin" target="_blank"><strong><code class="fv-code_inline">Tinymce-plugin</code></strong> </a></p>
<p>This is a focused offering <strong>Powerful, easy to use and rich</strong> \u7684 <a href="https://www.tiny.cloud" target="_blank"><code class="fv-code_inline">tinymce</code></a> Rich Text Editor <strong>plugin</strong>\u3001<strong>extend</strong> \u548C <strong>technology</strong> Technology community of\uFF0Cconvenient <strong>Exchange Discussion</strong>\uFF0C<strong>Sharing Experiences</strong> \u3002</p>
<p>There are many good plug-ins or projects in this community. Welcome to star \u2B50 follow</p>
</blockquote>
...
<p><strong>Tinymce-plugin All stable plugins in the community will be included in <a href="https://www.npmjs.com/package/tinymce-plugin" target="_blank"><strong>tinymce-plugin</strong></a> and <a href="https://www.npmjs.com/package/@npkg/tinymce-plugin" target="_blank"><strong>@npkg/tinymce-plugin</strong></a>. (Synchronization of the two)</strong></p>
</div>
<!--\u{1F680} \u8868\u793A\u5DF2\u7ECF\u5B9E\u73B0\u7684\u529F\u80FD
...
<hr>
</div></div><PagesRouter  docPath="en/guide/introduction.md" mapType="docs" docRepo="tinymce-plugin-docs" pagesName="introduction_t_xrr7bj1657292813299_p_" />`});export{i as default};
