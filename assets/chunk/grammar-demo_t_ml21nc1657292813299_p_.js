...
</code><div class="language-text" >vue</div></pre>`}};p.template=`<Preview class="demo-grammar-demo_t_ml21nc1657292813299_p_" :source="source()">
...
</code><div class="language-text" >vue</div></pre>`}};a.template=`<PreviewVue2 class="demo-grammar-demo_t_ml21nc1657292813299_p_"  :template="template()"  :source="source()">
...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" width="100%" style="width:100%;margin:auto 0;border:0px; min-height: 519px"  onload="autoIframeHeight(this)"  src="/demo/demo-grammar-demo_t_ml21nc1657292813299_p_1657292818230/index.html"></iframe>'}};j.template=`<PreviewIframe class="demo-grammar-demo_t_ml21nc1657292813299_p_" idx="Demo4"  :source="source()" :sourceCode="sourceCode()">
...
</code><div class="language-text" >vue</div></pre>`}};t.template=`<Preview class="demo-grammar-demo_t_ml21nc1657292813299_p_" :source="source()">
                                <template v-slot:demo><div>
 <h1>\u63D2\u4EF6demo\u5C55\u793A\u533A\u57DF</h1>
  <div class="vueDemo">
    <tinymce-vue v-model="content" :init="tinymceOptions" ></tinymce-vue>
...
</code><div class="language-text" >vue</div></pre>`}};n.template=`<PreviewVue2 class="demo-grammar-demo_t_ml21nc1657292813299_p_"  :template="template()"  :source="source()">
...
</code><div class="language-text" >html</div></pre>`},sourceCode(i){class e extends s.Component{constructor(c){super(c),this.state={reactDemoInitialValue:"<p>\u8FD9\u662F\u4E00\u4E2AREactDemo</p>"},this.reactDemoInit={min_height:220,base_url:"/tinymce",branding:!1,language:"zh_CN",menubar:!1,skeletonScreen:!0,plugins:["advlist autolink lists link image charmap print preview anchor","searchreplace visualblocks code fullscreen tpIndent2em autoresize tpCollapse tpTabs tpButtons","insertdatetime media table paste code help wordcount tpImportword"],toolbar:"undo redo tpIndent2em autoresize tpCollapse tpTabs tpButtons tpImportword | formatselect image | bold italic backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat | help",content_style:"body { font-family:Helvetica,Arial,sans-serif; font-size:14px }"},this.handleChange=r=>{this.setState({reactDemoInitialValue:r})}}render(){return s.createElement("div",null,s.createElement("h1",null,"tinymce demo2"),s.createElement("div",null,s.createElement(g,{initialValue:this.state.reactDemoInitialValue,init:this.reactDemoInit,onEditorChange:this.handleChange})),s.createElement("div",{dangerouslySetInnerHTML:{__html:this.state.reactDemoInitialValue}}))}}return u.render(s.createElement(e,null),i)}};m.template=`<PreviewReact class="demo-grammar-demo_t_ml21nc1657292813299_p_" idx="Demo7"  :source="source()">
...
<Demo1 data-isComponent="vue" class="demo-grammar-demo_t_ml21nc1657292813299_p_" />
 </demoGroupItem>
 <demoGroupItem title="Vue2">
<Demo2 data-isComponent="vue" class="demo-grammar-demo_t_ml21nc1657292813299_p_" />
 </demoGroupItem>
 <demoGroupItem title="React">
<Demo3  data-isComponent="react"  class="demo-grammar-demo_t_ml21nc1657292813299_p_" />
 </demoGroupItem>
</demoGroup>
<Demo4  data-isComponent="iframe" />
<Demo5 data-isComponent="vue" class="demo-grammar-demo_t_ml21nc1657292813299_p_" />
<Demo6 data-isComponent="vue" class="demo-grammar-demo_t_ml21nc1657292813299_p_" />
<Demo7  data-isComponent="react"  class="demo-grammar-demo_t_ml21nc1657292813299_p_" />
...
<codeBoxItem title="TinyMCE"><iframe scrolling="no" style="width:100%;margin:auto 0;border:0px; min-height: 220px"  onload="autoIframeHeight(this)"  src="/demo/codebox/demo-grammar-demo_t_ml21nc1657292813299_p_1657292818266/index.html"></iframe></codeBoxItem></codeBox></div></div><PagesRouter  docPath="guide/contributing/writing-guide/grammar-demo.md" mapType="docs" docRepo="tinymce-plugin-docs" pagesName="grammar-demo_t_ml21nc1657292813299_p_" />`});export{w as default};
